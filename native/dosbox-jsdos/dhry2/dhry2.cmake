...
if (${EMSCRIPTEN})
  ...
  set_target_properties(dhry2 PROPERTIES LINK_FLAGS "${DHRY2_LINK_FLAGS} -s WASM=1 -s ASYNCIFY=1 -s 'ASYNCIFY_IMPORTS=[\"syncSleep\"]' -s ASYNCIFY_WHITELIST=@${CMAKE_CURRENT_LIST_DIR}/../asyncify.txt -s EXPORT_NAME='WDHRY2'")
else()
  if (X86_64)
