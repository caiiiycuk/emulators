...
if (${EMSCRIPTEN})
    ...
    elseif (MINGW)
        ...
        target_link_libraries(dosbox-x-sokol X11 Xcursor Xi z ncurses dl pthread asound SDL2 SDL2_net)
        if (GL4ES)
            target_link_libraries(dosbox-x-sokol "${GL4ES_LIBRARY}")
            add_dependencies(dosbox-x-sokol gl4es)
        else()
            target_link_libraries(dosbox-x-sokol GL)
        endif()
